       ...
       <>
           <div className={"flex flex-col justify-center items-center"}>
               ...
               <div className={" w-full max-w-[800px] mt-5 p-5 justify-center items-center  rounded-md"}>
                   ...
                   <form  className={"h-full w-full mt-10 flex gap-5 flex-col"} netlify-honeypot="bot-field"  name="contact" method="POST" data-netlify="true">
                       ...
                       <div className={"flex gap-2 justify-between mt-4 items-center"}>
                           ...
                           <div className={`flex ${lightMode ? "bg-white/30 backdrop-blur" : "bg-black/30 backdrop-blur"} rounded-md justify-start gap-4 items-center`}>
