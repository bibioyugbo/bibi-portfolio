                            ...
                            <div data-aos="fade-in"  key={index} className={`rounded-xl p-4 ${lightMode?lightTheme:"bg-gray-800"}`}>
                                ...
                                <div className={"flex gap-5 items-center"}>
                                    ...
                                    <div className={"flex items-center justify-center gap-3"}>
                                        {project.github && <a target="_blank" className={"hover:scale-115 transition-transform"} rel="noopener noreferrer" href={project.github}>   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 12 12"><path fill={`${lightMode? '#000':'#fff'}`} d="M2 12h2v-1H3v-1H2V9H1V8h1v1h1v1h1V9h1V8H3V7H2V4h1V2h1v1h3V2h1v2h1v3H8v1H6v1h1v3h2v-1h1v-1h1V3h-1V2H9V1H2v1H1v1H0v7h1v1h1Zm0 0"/></svg></a>}
                                        <a className={"hover:scale-115 transition-transform"}  target="_blank" rel="noopener noreferrer" href={project.liveDemo}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="none" stroke={`${lightMode? '#000':'#fff'}`} stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6m-7 1l9-9m-5 0h5v5"/></svg></a>
                                    </div>
                                </div>
                            </div>
                        )
